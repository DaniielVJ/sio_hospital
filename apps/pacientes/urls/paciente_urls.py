...
from ..views import ActualizarPacienteView, CrearPacienteView, DetallePacienteView, EliminarPacienteView, MostrarMenuInicioPaciente, ListarPacientesView

app_name = "paciente"


urlpatterns = [
    path('', MostrarMenuInicioPaciente.as_view(), name="inicio"),
