    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('diurno', 'Diurno'), ('vespertino', 'Vespertino')], default='diurno', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='codigos_email', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foto_perfil', models.FileField(blank=True, upload_to='imagen_perfil/')),
                ('fecha_contratacion', models.DateField(blank=True)),
                ('activo', models.BooleanField(default=True)),
                ('rut', models.CharField(max_length=16, unique=True)),
                ('unidad_supervisacion', models.CharField(max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s', to=settings.AUTH_USER_MODEL)),
                ('turno', models.ForeignKey(help_text='No puedes eliminar un TURNO que ya halla sido asignado a una Matrona', on_delete=django.db.models.deletion.PROTECT, related_name='turno', to='perfiles.turno')),
            ],
            options={
