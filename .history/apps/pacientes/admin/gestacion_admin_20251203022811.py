...
class GestacionAdmin(admin.ModelAdmin):
    list_display = ("paciente", "matrona", "semana_gestacion", "dias_gestacion", "multiple", "numero_fetos", "riezgo", "fecha_ingreso", "terminado", "aborto")
    ...
    fieldsets = (
        "fields": (
            ("paciente", "matrona"),
            ("semana_gestacion", "dias_gestacion"),
            ("multiple", "numero_fetos"),
            "riezgo",
            "fecha_ingreso",
            ("terminado", "aborto"),
            (
